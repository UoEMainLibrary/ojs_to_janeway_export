...
def main():
    ...
    parser.add_argument("--output", default="/output/janeway_all_articles.csv", help="Article CSV output path")
    ...
    print(f"  Found {len(issues_sorted)} issue(s)")
    ...
    for issue in issues_sorted:
        ...
        print(f"\nProcessing {issue_label} (ID {issue['id']})...")

#!/usr/bin/python3
# @name: export_editors.py
# @creation_date: 2026-05-01
# @license: The MIT License <https://opensource.org/licenses/MIT>
# @author: Simon Bowie <simonxix@simonxix.com>
# @purpose: export editor uses from an OJS journal to Janeway Import CSV
# @acknowledgements:
# https://github.com/openlibhums/imports 
# https://janeway-imports.readthedocs.io/en/latest/editor_import.html

import argparse
from ojs_api import fetch_editorial_users
from janeway_csv import write_editors_csv

def main():
    parser = argparse.ArgumentParser(description="Export OJS editors to Janeway CSV.")
    ...
    parser.add_argument("--output", default="/output/janeway_editors.csv", help="Output CSV path")
    args = parser.parse_args()

    journal_url = f"{args.base_url.rstrip('/')}/{args.journal_path.strip('/')}"

    print("Fetching editorial users...")
